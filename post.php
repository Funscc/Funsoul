...
<div class="blog container">
  <div class="row">
    <div class="blog-main col-sm-12 col-md-9">
      <article>
        <h1 class="op-title yahei"><?php $this->title() ?><br/>
          <small>
            <span class="glyphicon1 glyphicon glyphicon-time" aria-hidden="true"></span><?php $this->date('F j, Y'); ?>
            <span class="glyphicon2 glyphicon glyphicon-eye-open hidden-xs" aria-hidden="true"></span>
            <span class="hidden-xs">阅读<?php get_post_view($this) ?>次</span>
            <a href="#comments" class="hidden-sm hidden-xs">
              <span class="glyphicon2 glyphicon glyphicon-fire" aria-hidden="true"></span>
              <?php echo $this->commentsNum(); ?>条评价
            </a>
            <a href="#comments" class="hidden-sm hidden-xs">
              <span class="glyphicon2 glyphicon glyphicon-pencil" aria-hidden="true"></span>我来吐槽</a>
              <span class="glyphicon2 glyphicon glyphicon-tag" aria-hidden="true"><?php $this->tags(', ', true, 'none'); ?></span>
            </small>
          </h1>
